...
export const liveTools: ToolModule[] = [
  ...
  { name: 'Code Diff', description: 'Compare snippets during review and debugging sessions.', path: '/tools/code-diff', icon: ArrowsRightLeftIcon, category: 'Code', maturity: 'Stable', privacy: 'Local', pillar: 'Debug Runtime Issues', priority: 2, featured: true },
  { name: 'Build Diff', description: 'Compare build outputs and artifact changes.', path: '/tools/build-diff', icon: CubeTransparentIcon, category: 'Builds', maturity: 'Stable', privacy: 'Local', pillar: 'Debug Runtime Issues', priority: 3 },
  { name: 'Bundle Analyzer', description: 'Inspect bundle size and composition.', path: '/tools/bundle-analyzer', icon: BuildingLibraryIcon, category: 'Builds', maturity: 'Experimental', privacy: 'Local', pillar: 'Debug Runtime Issues', priority: 4 },
  { name: 'Startup Profiling', description: 'Visualize React Native startup timelines.', path: '/tools/startup-profiling', icon: BoltIcon, category: 'Performance', maturity: 'Experimental', privacy: 'Local', pillar: 'Debug Runtime Issues', priority: 5 },
