...
const pages = [
  ...
  { url: '/tools/error-tracker/', changefreq: 'monthly', priority: 0.8 },
  { url: '/tools/http-profiler/', changefreq: 'monthly', priority: 0.8 },
  { url: '/tools/log-trace/', changefreq: 'monthly', priority: 0.8 },
  { url: '/tools/stack-trace/', changefreq: 'monthly', priority: 0.8 },
